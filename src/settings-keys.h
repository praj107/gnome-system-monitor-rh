...
#define GSM_SETTING_RESOURCES_GPU_EXPANDED  "resources-gpu-expanded"
...
#define GSM_SETTING_GPU_UTIL_COLOR          "gpu-util-color"
#define GSM_SETTING_GPU_MEM_COLOR           "gpu-mem-color"
